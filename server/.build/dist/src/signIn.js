    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, getUserByEmail(api, email).then(function (response) { return response.User; })];
            case 1:
                user = _b.sent();
                if (!user) {
                    return [2 /*return*/, { error: 'Brak użytkownika o podanym loginie' }];
                }
                return [4 /*yield*/, bcrypt.compare(password, user.password)];
            case 2:
                passwordIsCorrect = _b.sent();
                if (!passwordIsCorrect) {
                    return [2 /*return*/, { error: 'Nieprawidłowe hasło' }];
                }
