...
module.exports = function (event) { return __awaiter(_this, void 0, void 0, function () {
    var graphcool, api, _a, id, guests, i, len, e_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _a = event.data, id = _a.id, guests = _a.guests;
                i = 0, len = guests.length;
                _b.label = 1;
            case 1:
                if (!(i < len)) return [3 /*break*/, 4];
                return [4 /*yield*/, updateGuest(api, guests[i])];
            case 2:
                _b.sent();
                _b.label = 3;
            case 3:
...
function updateGuest(api, guest) {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    variables = {
                        ...
                        drinksIds: guest.drinks.map(function (drink) { return drink.id; }),
                    };
